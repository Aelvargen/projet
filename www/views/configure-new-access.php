...
<div class="container" id="container">
    ...
    <div class="form-container sign-in-container">
        ...
        <form action="" method="POST">
            ...
            <span>Avant d'utiliser le service, vous devez configurer un mot de passe différent de celui qui vous avez été attribué.</span>

            <input type="password" placeholder="Mot de passe" name="password1" />

            <input type="password" placeholder="Confirmez le mot de passe" name="password2" />
