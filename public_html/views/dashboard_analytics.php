...
<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li>
            <a href="dashboardAnalytics.php" class="active">
...
<section class="home-section">
    <nav>
        <div class="sidebar-button">
            ...
            <span class="dashboard">Analyses des Données</span>
        </div>
    ...
    <div class="home-content">
        <div class="overview-boxes">
            <div class="box">
                <div class="right-side">
                    <div class="box-topic">Déambulateur Sélectionné :</div>
        ...
        <div class="overview-boxes">
            <div class="box">
                <canvas id="pieChartHelpCalls" width="400" height="400"></canvas>
            </div>
            <div class="box">
                <canvas id="barChartActivity" width="400" height="400"></canvas>
            </div>
            <div class="box">
                <canvas id="doughnutChartHoursOfActivity" width="400" height="400"></canvas>
            </div>
            <div class="box">
                <canvas id="barChartAverageUsetime" width="400" height="400"></canvas>
        ...
        <div class="sales-boxes">
            <div class="recent-sales box">
                <div class="title">Temps d'utilisation des derninères sessions</div>
                <div class="sales-details">
                    <canvas id="lineChartActivity" width="400" height="400"></canvas>
                </div>
                <div class="button">
                    <a href="#">See All</a>
                </div>
            ...
            <div class="top-sales box">
                <div class="title">Position GPS du déambulateur</div>
        ...
        const myChart4 = new Chart(ctx4, {
            ...
            data: {
                labels: [
                    ...
                    'Appels d\'urgence entre 00h00 et 08h00',
                ],
                datasets: [{
                    label: 'test',
                    data: [300, 50, 100, 20],
